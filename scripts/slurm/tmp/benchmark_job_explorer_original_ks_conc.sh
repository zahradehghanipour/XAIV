#!/bin/bash
#SBATCH --job-name=vggnet16_benchmark2022_one_img_original_ks_conc
...
# --- MAIN VARIABLES
BENCHMARK="/home/z.dehghanipour/XAIV/benchmarks/vggnet16_benchmark2022_segmented_one_img_k_concentrated"
