...
class LiRPANet:
    ...
    def build_history_and_set_bounds(self, d, split, mode='depth', impl_params=None):
        ...
        domain_updater.set_branched_bounds(d, split, mode, self.branching_heuristic)
    ...
    from alpha import add_batch_alpha, copy_alpha, get_alpha, set_alpha
    from beta import get_beta, reset_beta, set_beta
    from cuts.cut_verification import (
        create_cutter,
        create_mip_building_proc,
        disable_cut_for_branching,
        enable_cuts,
        set_cut_new_split_history,
        set_cut_params,
        set_cuts,
        set_dependencies,
    )
    ...
    from prune import prune_lA, prune_reference_alphas
