...
# RL huristics
from heuristics.RL import RLNeuronBranching
...
def get_branching_heuristic(net, method=None):
    ...
    # xai
    elif branching_method.startswith('xai'):
        branching_args = arguments.Config['bab']['branching']['rl']
        branching_obj = RLNeuronBranching(net, branching_args)
